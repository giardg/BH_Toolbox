function [xvec, P_Joule, P_Hyst] = read_puissance(currentFolder, output)
...
filename = strcat('H0',{' '},string(H0),'_',pertesType,'_',string(longueur*1e3),'mm_',num2str(Temp),'deg.txt');
