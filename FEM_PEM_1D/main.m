...
param_num.correction    = false; %Appliquer la correction sur mu (lissage et correction a faible champ)
...
H0vec = [5,10,25,50,100]*1e3; %Liste de H0

for H0 = H0vec
    
    param_phy.H0            = H0; %amplitude du champ
    ...
    addpath('..\Resultats_transitoire_fortran_aisi4340','Fonctions_FEM','Fonctions_phi')
