...
Hcdata = [1.9543, 1.9968, 2.0060, 1.7740, 1.4920, 1.2475, 1.1728, 1.0474, 0.9755, 0.8285, 0.6811, 0.5895, 0.5074, 0.4201, 0.3093]*1e3;
H0vec = (10:5:100)*1e3;
param_phy.H0 = 75e3;
...
for H0 = H0vec
    ...
    for i = 1:length(Tempvec)
        ...
        close all
        Temp = Tempvec(i);
        param_phy.Temp            = Temp; %temperature
        param_phy.Hc = Hcdata(i);
        ...
        addpath('..\Resultats_transitoire_fortran_temp_ferrite','Fonctions_FEM','Fonctions_phi')
        ...
        filename = strcat('H0',{' '},string(param_phy.H0),'_mu',typename,'_',string(param_phy.longueur*1e3),'mm_',num2str(Temp),'deg');
